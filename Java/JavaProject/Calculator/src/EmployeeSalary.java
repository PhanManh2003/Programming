...
public class EmployeeSalary {
    ...
    public static double calculateSalary(int yearsOfService, double basicSalary, double performanceRating) {
    ...
    public static void main(String[] args) {
        ...
        double performanceRating = 2.5;

        System.out.println("salary: " + calculateSalary(yearsOfService, basicSalary, performanceRating));
    }
}
