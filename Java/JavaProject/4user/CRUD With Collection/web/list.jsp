...
<html lang="en">
    ...
    <body>
        ...
        <table class="student-list" border="1">
            ...
            <c:forEach items="${requestScope.list}" var="fu">
                <tr>
                    <td name="id"> ${fu.id}</td>
                    <td name="name">${fu.name}</td>
                    <td name="gender">${fu.gender == true ? 'male' : 'female'}</td>
                    ...
                    <td>
                        ...
                        <form action="student?action=delete" method="POST" >
                            ...
                            <a href="#" onclick="submitDelete(this)">Delete</a>
                        </form>
                    </td>
                </tr>
            </c:forEach>
        ...
        <script>
            function update(e) { // tham số e đại diện cho phần tử mà người dùng bấm vào
                ...
                filteredHobbies.forEach(function (hobby) {
                    ...
                    // kiểm tra xem thẻ checkbox có tồn tại không
                    if (checkbox) {
                        // nếu tồn tại thì tick
